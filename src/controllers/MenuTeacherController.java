...
public class MenuTeacherController {
    ...
    @FXML private Text myLoans, requestConsult, nameText, numIdentificationText, tiText, emailText, phoneText, roleText, pro_depText, password1Text, password2Text, title;;
    ...
    public void initialize() {
        ...
        // Usamos Platform.runLater para centrar los elementos una vez que la UI esté cargada
        Platform.runLater(() -> {
        ...
        // Listener para cuando cambie el ancho del pane (por redimensionamiento de la ventana, etc.)
        ...
        pane.heightProperty().addListener((obs, oldVal, newVal) -> {
            ...
            requestConsultImage.setLayoutY(((ySeparator2 + newVal.doubleValue()) - requestConsultImage.getFitHeight()) / 2);
            requestConsult.setLayoutY(requestConsultImage.getLayoutY() + requestConsultImage.getFitHeight()+10);
            
            closeSession.setLayoutY(newVal.doubleValue() - closeSession.getFitHeight() - 6);
        });   	
    }
